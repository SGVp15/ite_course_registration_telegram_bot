...
1	Григорьева Сабина Ильдаровна			(Сервис-менеджер,		asdasdqdq@stadasdep.ru	
        ...
        s = "Савушкин, Григорий, g.savushkin@itexpert.ru, https://events.webinar.ru/ITExpert/569285096/7ca38749207b4313ca9c9a420fefcdee"
...
class TestParserGET_LIST_USERS_FROM_STRING(TestCase):
    def test_webinar_parser(self):
        ...
        self.assertEqual(get_list_users_from_string(s)[0],
                         User(last_name='Григорьева', first_name='Сабина', email='asdasdqdq@stadasdep.ru',
                              url_registration='', webinar_events_id='999146969'))
